  ...
  <div class="card-body text-muted m-3">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="col-12" id="formulario">
        ...
        <div class="md-form form-lg">
		 ...
		 <div class="md-form form-lg">
          <i class="fa fa-user prefix"></i>
          <input type="text" id="cpf" name="cpf" class="form-control form-control-lg" pattern=".{11,11}" required title="de 11 a 11 caracteres">
          <label for="cpf">CPF</label>
        </div>
		 <div class="md-form form-lg">
          <i class="fa fa-user prefix"></i>
          <input type="text" id="endereco" name="endereco" class="form-control form-control-lg" pattern=".{1,255}" required title="de 1 a 255 caracteres">
          <label for="endereco">Endereço</label>
        </div>
		 <div class="md-form form-lg">
          <i class="fa fa-user prefix"></i>
          <input type="text" id="cidade" name="cidade" class="form-control form-control-lg" pattern=".{1,20}" required title="de 1 a 20 caracteres">
          <label for="cidade">Cidade</label>
        </div>
		 <div class="md-form form-lg">
          <i class="fa fa-user prefix"></i>
          <input type="text" id="uf" name="uf" class="form-control form-control-lg" pattern=".{2,2}" required title="de 1 a 2 caracteres">
